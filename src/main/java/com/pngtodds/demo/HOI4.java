...
public class HOI4 {
    ...
    public static void main(String[] args) {
        ...
        List<String> interfaceLargeList = new LinkedList<>();
        List<String> interfaceSmallList = new LinkedList<>();
        List<Localisation> localisationList = new LinkedList<>();
        List<Localisation> japaneseList = new LinkedList<>();
        List<Localisation> englishList = new LinkedList<>();
        List<Localisation> russianList = new LinkedList<>();

        String path = "C:\\Users\\91658\\Desktop\\Projects\\Java\\PNG-to-DDS\\src\\main\\resources\\tag\\CHI";
        FileUtil.loopFiles(path, PortraitUtils::isPng).forEach(file -> {
            ...
            Large large = PortraitUtils.getLarge(tag, nameKey, file.getParent());
            Small small = PortraitUtils.getSmall(nameKey, file.getParent());
